...
export class Footer {
    ...
    <div class="footer__contacts contacts">
        ...
        <span>+79398391297</span>

        </a>
        <ul class="contacts__list">
        <li class="contacts__item">
            <a href="#" class="contacts__link"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
    ...
    <ul class="footer__developer-list">
        ...
        Designer:
        <a href="#" class="footer__developer-link" target="_blank">Anastasia Ilina</a>
        </li>
        <li class="footer__developer-item">
        Developer:
        <a href="https://t.me/crosskain" class="footer__developer-link" target="_blank">Denis Fomin</a>
        </li>
    </ul>
